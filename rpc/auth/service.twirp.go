...
func NewAuthServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) AuthService {
	...
	serviceURL += baseServicePath(pathPrefix, "auth", "AuthService")
	urls := [3]string{
		serviceURL + "Register",
		serviceURL + "Login",
...
func (c *authServiceProtobufClient) Register(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
...
func (c *authServiceProtobufClient) callRegister(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
...
func (c *authServiceProtobufClient) ValidateToken(ctx context.Context, in *ValidateTokenRequest) (*ValidateTokenResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth")
	ctx = ctxsetters.WithServiceName(ctx, "AuthService")
...
func (c *authServiceProtobufClient) callValidateToken(ctx context.Context, in *ValidateTokenRequest) (*ValidateTokenResponse, error) {
...
func (c *authServiceJSONClient) Register(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth")
	ctx = ctxsetters.WithServiceName(ctx, "AuthService")
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	caller := c.callRegister
...
func (c *authServiceJSONClient) callRegister(ctx context.Context, in *RegisterRequest) (*RegisterResponse, error) {
	out := new(RegisterResponse)
...
func (c *authServiceJSONClient) ValidateToken(ctx context.Context, in *ValidateTokenRequest) (*ValidateTokenResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth")
	ctx = ctxsetters.WithServiceName(ctx, "AuthService")
	ctx = ctxsetters.WithMethodName(ctx, "ValidateToken")
	caller := c.callValidateToken
...
func (c *authServiceJSONClient) callValidateToken(ctx context.Context, in *ValidateTokenRequest) (*ValidateTokenResponse, error) {
	out := new(ValidateTokenResponse)
...
const AuthServicePathPrefix = "/twirp/auth.AuthService/"
...
func (s *authServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "auth.AuthService" {
...
func (s *authServiceServer) serveRegister(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *authServiceServer) serveRegisterJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	...
	handler := s.AuthService.Register
		...
		handler = func(ctx context.Context, req *RegisterRequest) (*RegisterResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.AuthService.Register(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*RegisterResponse)
...
func (s *authServiceServer) serveRegisterProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authServiceServer) serveValidateToken(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *authServiceServer) serveValidateTokenJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ValidateToken")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.AuthService.ValidateToken
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *ValidateTokenRequest) (*ValidateTokenResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.AuthService.ValidateToken(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ValidateTokenResponse)
...
func (s *authServiceServer) serveValidateTokenProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ValidateToken")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "auth", "AuthService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
